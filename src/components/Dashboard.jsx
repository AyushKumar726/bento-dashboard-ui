...
return ( <div className="min-h-screen p-6 bg-gradient-to-br from-pink-100 to-indigo-200"> <h1 className="text-4xl font-bold mb-8">
...
Bento Dashboard </h1>
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            <div className="text-center">
                ...
                <p className="font-bold text-red-500">32%</p>
            </div>

            <div className="text-center">
                <p className="text-sm text-gray-500">Avg Session</p>
                <p className="font-bold">4m 12s</p>
            </div>
    ...
    <div className="lg:col-span-2">
      <BentoCard title="Revenue">
        ...
        <div>
            ...
            <p className="font-bold text-red-500">12</p>
        </div>
        </div>
  ...
  <div className="mt-4 space-y-3">
    ...
    <div className="mt-4">
        ...
        <div className="bg-indigo-500 h-2 rounded-full w-[72%]"></div>
        </div>
    </div>
    </BentoCard>
    ...
    <BentoCard title="Schedule">
      ...
      <div className="mt-4 p-3 bg-orange-50 rounded-xl">
        ...
        <p className="font-semibold">09:00 AM - Team Sync</p>
      </div>
